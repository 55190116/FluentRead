 ...
 * 主要内容：统一转出 catalog、constants、credentials、customBody、customOpenAI、deeplx、inputTranslation、model、selectionTts、translationLoadingStyle、transfer 与 validation，保持调用方不必依赖内部文件布局。 可核对的公开符号包括 聚合导出。

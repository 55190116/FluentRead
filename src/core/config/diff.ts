...
export const CONFIG_DIFF_GROUPS = [
    {id: 'general', label: '通用'},
    {id: 'pageTranslation', label: '网页翻译'},
    {id: 'translationServices', label: '翻译服务'},
    {id: 'quickTranslation', label: '快捷翻译'},
    {id: 'siteRules', label: '网站规则'},
    {id: 'imageAndArea', label: '图片与区域'},
    {id: 'videoSubtitles', label: '视频字幕'},
...
const FIELD_DEFINITIONS: Record<string, FieldDefinition> = {
    ...
    display: {group: 'pageTranslation', label: '翻译模式', format: (value) => formatEnum(value, DISPLAY_LABELS)},
    style: {group: 'pageTranslation', label: '译文样式', format: (value) => formatEnum(value, STYLE_LABELS)},
    contextMenuEnabled: {group: 'pageTranslation', label: '右键全文翻译', format: formatBoolean},
    fullPageTranslationMode: {group: 'pageTranslation', label: '全文翻译范围', format: (value) => formatEnum(value, FULL_PAGE_MODE_LABELS)},
    disableFloatingBall: {group: 'pageTranslation', label: '全文翻译悬浮球', format: (value) => formatBoolean(value, true)},
    floatingBallPosition: {group: 'pageTranslation', label: '悬浮球位置', format: (value) => formatEnum(value, SIDE_LABELS)},
    floatingBallHotkey: {group: 'pageTranslation', label: '全文翻译快捷键', format: (value) => formatEnum(value, FLOATING_HOTKEY_LABELS)},
    customFloatingBallHotkey: {group: 'pageTranslation', label: '自定义全文快捷键'},
    translationProgressPanelEnabled: {group: 'pageTranslation', label: '翻译进度面板', format: formatBoolean},

    service: {group: 'translationServices', label: '默认翻译服务', format: (value) => formatEnum(value, SERVICE_LABELS)},
    ...
    hotkey: {group: 'quickTranslation', label: '鼠标悬浮快捷键', format: (value) => formatEnum(value, HOVER_TRIGGER_LABELS)},
    customHotkey: {group: 'quickTranslation', label: '自定义悬浮快捷键'},
    mouseHoverTranslationDelay: {group: 'quickTranslation', label: '悬浮翻译延迟', format: (value) => formatNumber(value, ' ms')},
    disableSelectionTranslator: {group: 'quickTranslation', label: '划词翻译', format: (value) => formatBoolean(value, true)},
    selectionTranslatorMode: {group: 'quickTranslation', label: '划词显示模式', format: (value) => formatEnum(value, SELECTION_MODE_LABELS)},
    selectionTranslatorTrigger: {group: 'quickTranslation', label: '划词触发方式', format: (value) => formatEnum(value, SELECTION_TRIGGER_LABELS)},
    selectionTranslatorHotkey: {group: 'quickTranslation', label: '划词快捷键', format: (value) => formatEnum(value, SELECTION_TRIGGER_LABELS)},
    customSelectionTranslatorHotkey: {group: 'quickTranslation', label: '自定义划词快捷键'},
    selectionTranslatorDelay: {group: 'quickTranslation', label: '划词显示延迟', format: (value) => formatNumber(value, ' ms')},
    selectionTtsVoices: {group: 'quickTranslation', label: '划词朗读音色'},
    inputBoxTranslationTrigger: {group: 'quickTranslation', label: '输入框翻译触发方式', format: (value) => formatEnum(value, INPUT_TRIGGER_LABELS)},
    inputBoxTranslationTarget: {group: 'quickTranslation', label: '输入框翻译目标语言', format: (value) => formatEnum(value, LANGUAGE_LABELS)},
    ...
    enableAIContext: {group: 'advanced', label: 'AI 智能上下文', format: formatBoolean},

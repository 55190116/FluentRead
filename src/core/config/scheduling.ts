...
export const DEFAULT_TRANSLATION_REQUESTS_PER_SECOND = 0;
export const MIN_TRANSLATION_REQUESTS_PER_SECOND = 0;
export const MAX_TRANSLATION_REQUESTS_PER_SECOND = 1000;
export const DEFAULT_TRANSLATION_REQUESTS_PER_MINUTE = 0;
...
export const DEFAULT_TRANSLATION_BACKOFF_BASE_MS = 1000;
export const MIN_TRANSLATION_BACKOFF_BASE_MS = 100;
export const MAX_TRANSLATION_BACKOFF_BASE_MS = 60_000;
export const DEFAULT_TRANSLATION_BACKOFF_MAX_MS = 30_000;

 ...
 * 主要内容：汇集 B 站、Discord、GitHub、GNU、Hacker News、LearnOpenGL、Reddit、X/X Chat 与 YouTube 适配器，按 priority 和声明顺序生成 defaultTranslationAdapters。 可核对的公开符号包括 defaultTranslationAdapters。

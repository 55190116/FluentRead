 ...
 * 主要内容：识别 heading、block、inline、纯文本正文 pre、结构标签、嵌入式 aside 和 reparent 边界，限制直接子节点探测数量，并提供候选目标及内联 run 相关的布局函数。 可核对的公开符号包括 isSemanticHeadingElement、getElementDisplay、isBlockBoundary、isStructuralContainer、hasStructuralAncestor、isTranslationControlElement、hasDirectReadableText、hasReadableBlockChild。

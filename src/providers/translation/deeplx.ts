 ...
 * 主要内容：规范化 AUTO、ZH 等语言代码，从 core 配置解析候选地址，逐端点请求并校验 code/data，导出 translateDeepLXText 与默认 provider。 可核对的公开符号包括 getDeepLXRequestLanguages、translateDeepLXText、default:deeplx。

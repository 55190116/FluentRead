 ...
 * 主要内容：文件从 runtime.ts 精确再导出 isAreaTranslatorMounted、mountAreaTranslator 与 unmountAreaTranslator，并从 contextMenuBridge.ts 导出右键触发入口，不暴露内部 Vue 实例、挂载 Promise 或请求所有权计数。
...
export {startAreaTranslationFromContextMenu} from './contextMenuBridge';

 ...
 * 主要内容：从 core.ts 导出 areaRectToImageCrop 与 AreaTranslationSelection，并从 content 入口导出 isAreaTranslatorMounted、mountAreaTranslator、unmountAreaTranslator 与右键触发入口。

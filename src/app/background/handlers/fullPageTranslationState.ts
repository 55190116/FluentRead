 ...
 * 主要内容：转发 full-page-translation feature 的状态查询、状态更新与 QQ 邮件子页面转发处理器及其公开类型，使翻译中、已翻译和恢复态可以按 tab 维护。
...
export {createQqMailFrameBackgroundHandlers, type QQMailFrameBackgroundContext} from '@/src/features/full-page-translation/background/qqMailFrameHandlers';

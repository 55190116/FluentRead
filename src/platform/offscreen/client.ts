...
export const OFFSCREEN_CANCEL_LOCAL_TRANSLATION_MESSAGE_TYPE = 'CANCEL_LOCAL_TRANSLATION_OFFSCREEN' as const;
export const OFFSCREEN_CANCEL_LOCAL_TTS_MESSAGE_TYPE = 'CANCEL_LOCAL_TTS_OFFSCREEN' as const;

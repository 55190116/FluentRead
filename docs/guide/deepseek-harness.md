...
默认选中文字只显示动作，点击后才调用 AI。也可以在翻译卡片设置的 **翻译设置 → 打开方式** 中选择：
...
先在 **启用与服务** 中开启功能，紧接着可以展开 **试试翻译卡片**，查看不同动作的演示回答，不会调用模型。

**翻译设置** 将翻译服务与模型、打开方式与动作、回答长度与学习程度、原文范围集中在一个设置栏中。学习记忆和提示词各自独立，按需设置。
